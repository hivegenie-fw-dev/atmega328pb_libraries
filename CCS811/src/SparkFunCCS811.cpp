...
CCS811Core::CCS811_Status_e CCS811Core::beginCore(wire2::TwoWire &wirePort)
{
...
//
//****************************************************************************//
bool CCS811::begin(wire2::TwoWire &wirePort)
{
...
//
//****************************************************************************//
CCS811Core::CCS811_Status_e CCS811::beginWithStatus(wire2::TwoWire &wirePort)
{
	...
	returnError = setDriveMode(2); //Read every 10seconds
