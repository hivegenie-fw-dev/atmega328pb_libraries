...
public:
	...
	CCS811_Status_e beginCore(wire2::TwoWire &wirePort);
...
protected:
	//Variables
	wire2::TwoWire *_i2cPort; //The generic connection to user's chosen I2C hardware
	uint8_t I2CAddress;
};
...
public:
	...
	bool begin(wire2::TwoWire &wirePort = Wire2);							  //Use the Wire hardware by default
	CCS811_Status_e beginWithStatus(wire2::TwoWire &wirePort = Wire2);		  //Use the Wire hardware by default
